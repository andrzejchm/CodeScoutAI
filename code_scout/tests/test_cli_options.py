...
def test_code_paths_option_from_env_multiple():
...
def test_code_paths_option_from_env_single():
...
def test_code_paths_option_from_cli_multiple():
...
def test_code_paths_option_from_cli_single():
...
def test_code_paths_option_no_value_required_true():
    """Test code_paths_option when no value is provided and it's required."""
    app = typer.Typer()
...
def test_file_extensions_option_from_env_multiple():
...
def test_file_extensions_option_from_env_single():
...
def test_file_extensions_option_from_cli_multiple():
...
def test_file_extensions_option_from_cli_single():
...
def test_file_extensions_option_no_value():
...
def test_cli_option_precedence_cli_over_env():
